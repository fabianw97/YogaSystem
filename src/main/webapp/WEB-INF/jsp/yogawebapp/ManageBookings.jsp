...
<meta name="description" content="Manage Bookings Page">
...
<!-- favicons end  -->
<title>Manage Your Classes | Yoga App</title>
...
<body>
	...
	<div class="container">
		...
		<div class="jumbotron">
			...
			<p>Here you can view and cancel your currently booked classes</p>
				...
				<table class="table table-bordered">
					...
					<tbody>
						...
						<c:forEach items="${userBookings}" var="bookings">
							<tr>
								<td>${bookings.id}</td>
								<td><fmt:parseDate value="${bookings.dateCreated}"
										pattern="yyyy-MM-dd" var="datecreated" /> <fmt:formatDate
										value="${datecreated}" pattern="dd-MM-yy" /></td>
								...
								<td><fmt:parseDate value="${bookings.timeStart}"
										pattern="HH:mm:ss" var="timeStart" /> <fmt:formatDate
										value="${timeStart}" pattern="HH:mm" /> -<fmt:parseDate
										value="${bookings.timeEnd}" pattern="HH:mm:ss" var="timeEnd" />
									<fmt:formatDate value="${timeEnd}" pattern="HH:mm" />
								<td><form role="form " action="cancel" method="POST">
										<button name="booking_id" type="submit" class="btn btn-danger"
											value="${bookings.id}">Cancel</button>
									</form></td>
							</tr>
						</c:forEach>
